...
## Beschreibung
Spengergram ist eine kompakte Social-Media-App, die es Nutzern ermöglicht, sich zu registrieren, Fotos zu teilen und diese auf einer Timeline zu liken.
Zusätzlich bietet die App Funktionen zum Verwalten von Freundschaften und ein separates Admin-Dashboard.
Als vereinfachte Version von Instagram dient Spengergram als praxisorientiertes Lernprojekt, in dem Studierende sowohl grundlegende als auch fortgeschrittene Techniken der App-Entwicklung im realen Einsatz erlernen.
