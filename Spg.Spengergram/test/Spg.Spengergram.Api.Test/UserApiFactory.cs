...
namespace Spg.Spengergram.Api.Test
{
    public class UserApiFactory : WebApplicationFactory<Program>
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            {
                var descriptor = services.First(d => d.ServiceType == typeof(DbContextOptions<SqLiteDatabase>));
        ...
        public void InitializeDatabase(Action<UnitTestDatabase> action)
        {
            using var scope = Services.CreateScope();
            using var db = scope.ServiceProvider.GetRequiredService<UnitTestDatabase>();
